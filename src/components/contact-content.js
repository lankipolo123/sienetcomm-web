    ...
    return html`
      <section style="background: #f9fafb; padding: 64px 80px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; margin-bottom: 48px;">
          ...
          <div style="background: white; border-radius: 14px; border: 1px solid #e5e7eb; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.04);">
            ...
            <div style="font-size: 0.85rem; color: #374151; line-height: 1.9;">
              +63 2 7527 1448<br>
              +63 2 8524 6084<br>
              +63 2 7000 1572
            </div>
          ...
          <div style="background: white; border-radius: 14px; border: 1px solid #e5e7eb; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.04);">
            ...
            <div style="font-size: 0.85rem; color: #374151; line-height: 1.9;">
              +63 917 324 7630<br>
              +63 923 144 5729<br>
              <span style="color: #9ca3af; font-size: 0.8rem;">Fax: +632-82844732</span>
            </div>
          </div>
          ...
          <div style="background: white; border-radius: 14px; border: 1px solid #e5e7eb; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.04);">
            ...
            <a href="https://www.sienetcomm.com" target="_blank" style="color: #1A6B2A; font-size: 0.85rem; display: block;">www.sienetcomm.com</a>
          </div>
